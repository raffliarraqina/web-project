...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Ubah Event</h5>
            ...
            <div class="p-3">
                <form class="row g-3" action="{{ route('dashboard.event.update', $event->id) }}" method="post"
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputEventName" value="{{ $event->title }}"
                            name="title" required>
                    </div>

                    <div class="col-md-12">
                        <label for="inputImageEvent" class="form-label"><strong>Gambar</strong></label>
                        <input type="file" class="form-control" id="inputImageEvent" name="image">
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" id="editor" cols="30" rows="10"> {!! $event->description !!} </textarea>
